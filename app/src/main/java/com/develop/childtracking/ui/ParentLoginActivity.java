...
public class ParentLoginActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Users").child("Parents").child(userId);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent intent = new Intent(ParentLoginActivity.this, ParentChildsActivity.class);
    ...
    private void showMessage(String msg) {
        Toast.makeText(ParentLoginActivity.this, msg, Toast.LENGTH_SHORT).show();
    }
